process NECAT {
    ...
    sed -i 's/PREP_OUTPUT_COVERAGE=40/PREP_OUTPUT_COVERAGE=80/g' ${sample_id}_config.txt
    sed -i 's/CNS_OUTPUT_COVERAGE=30/CNS_OUTPUT_COVERAGE=80/g' ${sample_id}_config.txt
